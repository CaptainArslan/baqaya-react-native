    ...
    >
      ...
      <View style={styles.section}>
        ...
        <Row
          ...
          onPress={() =>
            closeThen(() =>
              props.navigation.navigate("business-profile" as never),
            )
          }
        />
        <Row
          ...
          icon="privacy-tip"
          onPress={() =>
            closeThen(() => props.navigation.navigate("privacy-policy" as never))
          }
        />
        <Row
        ...
        <Row
          ...
          onPress={() =>
            closeThen(() =>
              props.navigation.navigate("delete-account" as never),
            )
          }
        />
      </View>
